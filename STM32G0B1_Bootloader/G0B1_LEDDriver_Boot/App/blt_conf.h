...
/** \brief Configure CAN message ID target->host (LEDDriver bootloader TX). */
#define BOOT_COM_CAN_TX_MSG_ID          (0x161)
/** \brief Configure CAN message ID host->target (LEDDriver bootloader RX,
 *         also reused by the application as the "enter bootloader" reset trigger). */
#define BOOT_COM_CAN_RX_MSG_ID          (0x160)
